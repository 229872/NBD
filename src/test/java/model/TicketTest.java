...
public class TicketTest {
    ...
    public void normalTicketCreationTest() throws WrongValueException {
        ...
        assertEquals(client.getId(),ticket.getClientId());
        assertEquals(movie.getId(),ticket.getMovieId());
    }
    ...
    public void studentTicketCreationTest() throws WrongValueException {
        ...
        Movie movie = new Movie("Star Wars I", "SCI_FI", 13,
                160, 140);
        Client client = new Client("John", "Doe", address);
        Student ticket = new Student(basePrice, seat, client.getId(), movie.getId(), studentId, schoolType);
    ...
    public void seniorTicketCreationTest() throws WrongValueException {
        ...
        Movie movie = new Movie("Star Wars I", "SCI_FI", 13,
                160, 140);
        Client client = new Client("John", "Doe", address);
        Senior ticket = new Senior(basePrice, seat, client.getId(), movie.getId(), seniorId, age);
...
//        assertEquals(basePrice,ticket.getTicketPrice(),0.00001);
    ...
    public void seniorGetTicketPriceTest() throws WrongValueException {
        ...
        Movie movie = new Movie("Star Wars I", "SCI_FI", 13,
                160, 140);
        Client client = new Client("John", "Doe", address);
        Ticket ticket = new Senior(basePrice, seat, client.getId(), movie.getId(),123,age);

//        assertEquals(price,ticket.getTicketPrice(),0.00001);
        age = 70;
        price = basePrice - basePrice * Math.pow(age,2) * 0.0001;
        Ticket ticket2 = new Senior(basePrice, seat, client.getId(), movie.getId(),123,age);
//        assertEquals(price,ticket2.getTicketPrice(),0.00001);
        age = 90;
        Ticket ticket3 = new Senior(basePrice, seat, client.getId(), movie.getId(),123,age);
//        assertEquals(3.5,ticket3.getTicketPrice(),0.00001);
    ...
    public void studentGetTicketPriceTest() throws WrongValueException {
        ...
        Movie movie = new Movie("Star Wars I", "SCI_FI", 13,
                160, 140);
        Client client = new Client("John", "Doe", address);
        Student student1 = new Student(basePrice, seat, client.getId(), movie.getId(), 123,
                SchoolType.PRIMARY_SCHOOL);
        Student student2 = new Student(basePrice, seat, client.getId(), movie.getId(), 123,
                SchoolType.HIGH_SCHOOL);
        Student student3 = new Student(basePrice, seat, client.getId(), movie.getId(), 123,
                SchoolType.STUDIES);
